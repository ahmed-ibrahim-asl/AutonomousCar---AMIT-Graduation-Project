...
#define OBSTACLE_DISTANCE_THRESHOLD 65  // Minimum distance to an obstacle in cm
#define MAX_DISTANCE 150                // Maximum sensing distance
#define TURN_DURATION_MS 700            // Duration for turning (adjust as needed)
